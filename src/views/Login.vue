<template>
	<div>
		...
		<div class="max-w-xl mx-auto bg-white p-2 rounded-lg shadow-lg -mt-6 font-sans">
			<div class="flex flex-wrap">
				<div class="w-full sm:w-full md:w-1/3 p-2">
					<div @click="signIn('google')" class="flex flex-col rounded-lg bg-grey-light py-6 items-center justify-center border-2 border-transparent hover:border-purple cursor-pointer outline-none">
						<div>
				...
				<div class="w-full sm:w-full md:w-1/3 p-2">
					<div @click="signIn('twitter')" class="flex flex-col rounded-lg bg-grey-light py-6 items-center justify-center border-2 border-transparent hover:border-purple cursor-pointer outline-none">
						<div>
				...
				<div class="w-full sm:w-full md:w-1/3 p-2">
					<div @click="signIn('facebook')" class="flex flex-col rounded-lg bg-grey-light py-6 items-center justify-center border-2 border-transparent hover:border-purple cursor-pointer outline-none">
						<div>
